...
namespace PartY
{
    public class Client_PlayerController : MonoBehaviour
    {
        public bool isForServerOnly;
        public Client_PlayerController theOtherBall;
        ...
        private void Update()
        {
            if (PartY_Globals.isServer && isForServerOnly || PartY_Globals.isServer == false && isForServerOnly == false)
            {
